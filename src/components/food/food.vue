        ...
        <div class="content">
          ...
          <transition name="fade"
            ...
            <div v-if="food.count"
                 ...
                 key="cartcontrol-wrapper">
              <cartcontrol :food="food"
                           @cart-add="addAgain"></cartcontrol>
            </div>
            <div v-else
          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-show="needShow(rating.rateType, rating.text)"
                ...
                <div class="time">{{rating.rateTime | formatRateTime}}</div>
                <p class="text">
...
export default {
  ...
  methods: {
    ...
    addFirst(event) {
      ...
      this.$emit('cart-addFood', event.target)
    },
    addAgain(target) {
      this.$emit('cart-addFood', target)
    },
    needShow(type, text) {
